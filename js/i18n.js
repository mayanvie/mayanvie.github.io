(function () {
  ...
  var strings = {
    ...
    vi: {
      ...
      'home.p4.desc': 'Job aid theo trình tự ca, viết từ quầy. Checklist mở cửa, dine-in vs. app, và vài quy tắc không được đoán.',
      ...
      'cashier.note': '<strong>Ghi chú portfolio:</strong> Mình viết guide này khi thực tập FOH, sau khi thấy nhân viên mới học máy và luồng order lệch nhau tùy người hướng dẫn hôm đó. Quản lý đã duyệt để dùng. Mình nghỉ sớm sau đó nên chưa kịp pilot với người mới — logic thiết kế thì thật, số liệu rollout thì chưa. Tên quán, số tiền, và cơ chế khuyến mãi đã được bỏ hoặc khái quát hóa.',
      'cashier.sum1.t': 'Người học',
      'cashier.sum1.p': 'Nhân viên Order & Cashier mới. Vai trực tiếp, biến động cao. Phải chào khách, nhận order, thu tiền, pha cà phê, và hỗ trợ sàn khi rảnh — thường ngay ca đầu gặp máy.',
      'cashier.sum2.t': 'Vấn đề',
      'cashier.sum2.p': 'Training nằm ở người đang ca. Máy POS, quỹ đầu ca, dine-in vs. app, và việc phải làm khi sai — mỗi người giải thích một kiểu. Dễ đoán. Đoán ở quầy thu ngân thì đắt.',
      'cashier.sum3.t': 'Mình đã làm',
      'cashier.sum3.p': 'Viết guide theo trình tự ca, người mới mở được ngày đầu: checklist mở cửa, luồng dine-in và app, quy tắc khi sai, đóng ca, vài điều không được đoán, và glossary. Quản lý đã duyệt. Chưa dùng với người mới.',
      'cashier.sum4.t': 'Mục tiêu thiết kế',
      'cashier.sum4.p': 'Thu ngân mới chạy được một ca theo đúng thứ tự thời gian, không phải đợi senior rảnh. Vài quy tắc không được đoán — quỹ, loại thanh toán, không ghi đè order, hỏi lead — nằm ở đầu, không chôn trong sổ tay.',
